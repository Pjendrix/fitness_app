...
export default function History({ go }) {
  ...
  return (
    <div className="screen">
      <header className="screen-head row-between"><h1>Historie</h1><button className="btn btn-ghost btn-sm" onClick={() => go('stats')}>Statistiky a grafy</button></header>
      ...
      {workouts.map((w) => {
        ...
        return (
          <section className="card hist" key={w.id}>
