...
export function StoreProvider({ children }) {
  ...
  useEffect(() => {
    ...
    let first = true;
    // Živé meta (D1): první doručení = načteno; další = změny z jiného zařízení nebo potvrzení vlastních zápisů.
    const unsubMeta = api.subscribeMeta((d, meta) => {
      if (cancelled) return;
    ...
    return () => { cancelled = true; unsub(); unsubMeta(); };
