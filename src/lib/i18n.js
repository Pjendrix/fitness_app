...
const D = {
  en: {
    ...
    'ms.fullText': 'Weekly volume, workout load, the full record table and exercise comparisons are in the full analytics — best on desktop.',
    'ms.fullBtn': 'Full analytics', 'ms.metric': 'Metric', 'ms.since': 'since {d}', 'ms.nSessions': { one: '{n} session', other: '{n} sessions' },
    ...
    'prof.demoA': 'Athlete A', 'prof.demoB': 'Athlete B',
  ...
  cs: {
    ...
    'ms.fullText': 'Týdenní objem, náročnost tréninků, celá tabulka rekordů a srovnání cviků jsou v plné analytice – nejlépe na desktopu.',
    'ms.fullBtn': 'Plná analytika', 'ms.metric': 'Metrika', 'ms.since': 'od {d}', 'ms.nSessions': { one: '{n} trénink', few: '{n} tréninky', many: '{n} tréninku', other: '{n} tréninků' },
    ...
    'prof.demoA': 'Sportovec A', 'prof.demoB': 'Sportovec B',
